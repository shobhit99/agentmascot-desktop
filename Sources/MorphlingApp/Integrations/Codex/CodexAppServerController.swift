...
enum CodexAppServerError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        switch self {
        case .executableNotFound:
            return "Codex CLI not found. Install Codex or set MORPHLING_CODEX_PATH to the executable."
...
enum CodexExecutableResolver {
    static func resolve(
        ...
        if let explicitPath = environment["MORPHLING_CODEX_PATH"], !explicitPath.isEmpty {
...
actor CodexAppServerController {
    ...
    func start() async throws {
        ...
        let logURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("morphling-codex-app-server-\(UUID().uuidString).log")
    ...
    private func connectAndInitialize() async throws {
        ...
        let initData = try JSONSerialization.data(withJSONObject: [
            ...
            "method": "initialize",
            "params": [
                "clientInfo": ["name": "morphling", "title": "Morphling", "version": "0.1.2"],
