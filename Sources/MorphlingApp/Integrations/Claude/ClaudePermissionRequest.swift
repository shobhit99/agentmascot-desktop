...
struct ClaudePermissionRequest: Sendable {
    ...
    func response(answers: [String:[String]]) -> [String:Any] {
        ...
        return ["hookSpecificOutput": ["hookEventName":"PermissionRequest", "permissionDecision":"allow", "permissionDecisionReason":"Answered by user in Morphling", "updatedInput":["answers":map]]]
    }
    static var safeFallback: [String:Any] { ["hookSpecificOutput":["hookEventName":"PermissionRequest", "permissionDecision":"ask", "permissionDecisionReason":"Morphling unavailable; ask in Claude Code"]] }
}
